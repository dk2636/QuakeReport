...
/**
 * Created by Kokorogiannis on 6/7/2017.
...
public final class Utils {
     ...
     * directly from the class name Utils (an object instance of Utils is not needed).
     */
    private Utils() {
    }
     ...
     */
    public static List<Earthquake> extractEarthquakes(String aJSONResponse) {
        ...
        try {
            JSONObject jsonResponse = new JSONObject(aJSONResponse);
            JSONArray jsonEarthquake = jsonResponse.getJSONArray("features");
            // looping through All features
            for (int i = 0; i < jsonEarthquake.length(); i++) {
                JSONObject feature = jsonEarthquake.getJSONObject(i);
                // Properties is JSON Object
